...
function AdminSupportMessage() {
  ...
  useEffect(() => {
    ...
    /*
     * Do not attempt to read messages until
     * admin access has been confirmed.
     */
     ...
     * IMPORTANT FIX:
     *
     * Seller/customer Settings writes to:
     *
     * supportMessages
     *
     * NOT:
        ...
        <main className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mb-5">
            ...
            <p className="text-sm text-gray-500 mt-1">
              View and manage messages sent
              to CampusMart support.
            </p>
