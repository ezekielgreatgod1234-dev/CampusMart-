...
function AdminUsers() {
  ...
  //
  // Users created before this system was added are treated
  // as active automatically.
  // =========================================================
  ...
  const updateUser = async (userId, data) => {
    ...
    try {
      ...
      alert(
        "Could not update user. Check your Firestore rules."
      );
    } finally {
      setUpdatingId(null);
    }
  ...
  const handleSuspendToggle = async (user) => {
    ...
    // Never allow the admin to suspend an admin account
    const isAdminUser =
      user.role === "admin" ||
    ...
    if (isAdminUser) {
      alert(
        "Admin accounts cannot be suspended from this page."
      );
      return;
    }
