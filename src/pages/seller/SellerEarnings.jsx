...
function SellerEarnings({ unreadMessages = 0 }) {
  ...
  return (
    <div className="h-screen w-full bg-gray-50 text-gray-800 font-sans overflow-hidden">
      ...
      {/* SIDEBAR — matches SellerDashboard exactly */}
      ...
      <div
        ...
        "
      >
        {/* TOP BAR — matches SellerDashboard */}
        ...
        >
            ...
            >
              ...
              <div className="relative z-20">
                ...
                <p className="text-sm sm:text-base text-green-50 mt-1.5 max-w-xl leading-6">
                  See your total earnings, available balance, and
                  recent income from sales.
                </p>
              </div>
            </div>
          </section>
            ...
            >
              ...
              <div className="relative mt-4 sm:mt-5">
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleNavigation("/seller/withdraw")
                  }
                  className="
                    mt-3
                    sm:mt-4
          ...
          >
            ...
            <button
              type="button"
              onClick={() =>
                handleNavigation("/seller/settings")
              }
              className="
                h-9
                px-4
