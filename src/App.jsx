...
function AdminRoute({
  ...
  if (!profileResolved) {
    return (
      <LoadingScreen text="Loading your admin account..." />
    );
  }
...
function CustomerRoute({
  ...
  if (role !== "buyer") {
    return (
      <LoadingScreen text="Preparing your account..." />
    );
  }
...
function SellerRoute({
  ...
  if (!profileResolved) {
    return (
      <LoadingScreen text="Loading your seller account..." />
    );
  }
