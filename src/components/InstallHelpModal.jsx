          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <InstallStep number="2" icon={FiPlusSquare}>
                Select the desktop screen with download icon and then tap <span className="font-semibold text-gray-800">"Install app"</span> or <span className="font-semibold text-gray-800">"Add to Home screen"</span>.
              </InstallStep>
